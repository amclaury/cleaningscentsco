...
<body>
  ...
  <nav class="cyan accent-4">
    <div class="nav-wrapper container80"><a id="logo-container" href="home.php" class="brand-logo"><img class="responsive-img pad-extra" src="img/wordmark.png" <img style="width:378x; height:68px;"></a>
...
<input type="hidden" value="makoframework.com" name="as_sitesearch"></input>
  ...
  <div class="row">
    <div class="col s12">
          ...
          <form>
              <div class="row">
                <div class="input-field col s12">
                  <input id="street" type="text" class="validate" data-length="40">
                ...
                <div class="input-field col s6">
                  <input id="city" type="text" class="validate" data-length="30">
                  <label for="city">City</label>
                </div>

                <div class="input-field col s6">
                  <input id="zip" type="number" class="validate" data-length="5">
		...
		<?php echo $shipping_cost. $list_tax; ?>Amount Payable : 
		<?php echo sprintf("%01.2f", $grand_total);?></span></td></tr>
        ...
        <li>
          ...
          <form>
              <div class="row">
				...
				<div class="input-field col s6">
                  <input id="state" type="number" class="validate" data-length="2">
...
echo $current_url; ?>" />
		...
		<ul class="collapsible" data-collapsible="accordion">
          ...
          <form class="col s12" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            <div class="row">
              <div class="input-field col s6">
                <input id="name" type="text" class="validate" name="name" data-length="20">
                <label for="name">Username</label>
              </div>
