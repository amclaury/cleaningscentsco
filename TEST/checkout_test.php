  ...
  <nav class="cyan accent-4">
    <div class="nav-wrapper container"><a id="logo-container" href="home.php" class="brand-logo">Cleaning Scents</a>
      <ul class="right hide-on-med-and-down">
        <li><a href="catalog_test.php">SHOP</a></li>
        <li><a href="admin.php">ADMIN</a></li>
        <li><a href="client.php">PROFILE</a></li>
        <li><a href="cart_test.php">YOUR CART</a></li>
	  ...
	  <ul id="nav-mobile" class="side-nav">
	    ...
	    <li><a href="admin.php">ADMIN</a></li>
        <li><a href="client.php">PROFILE</a></li>
		<li><a href="cart_test.php">CART</a></li>
	 </ul>
  ...
  if(isset($_SESSION["cart_test"])) //check session var
    ...
    ?>
			...
			<p>Payment Options</p>
				<div class="row">
                <div class="input-field col s12">
                  <input id="credit_card" type="text" class="validate" data-length="20">
                  <label for="credit_card">Credit Card</label>
                </div>     
                <div class="input-field col s12">
                  <input id="paypal" type="text" class="validate" data-length="20">
