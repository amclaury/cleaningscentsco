...
$test_item .= <<<EOT
  ...
  <div class="product-thumb card-image"><img alt="productimage" class="img_thumb" src="{$obj->product_img_name}"></div>
  <div class="product-content card-content"><h3>{$obj->product_name}</h3></div>
