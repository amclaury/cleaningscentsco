    ...
    <ul class="slides">
      <li>
        ...
        <div class="caption center-align">
          ...
          <div class="section">
          <a class="btn waves-effect white grey-text darken-text-2" href="catalog.php">shop</a>
          </div>
        </div>
      </li>
      <li>
  ...
  <div class="container">
    <div class="section">
      ...
      <!--FEATURED PRODUCT-->
        ...
        <div class='card horizontal'><div class='card-image'><img alt='applesoap' src ='product_img/apple_hand.jpg'></div><div class='card-stacked'><div class='card-content'><span class='card-title grey-text'>Mrs. Meyer's Apple Hand Soap</span><p>&#36;4</p><br /><p>Relaxing floral scent</p></div><div class='card-action'><a href='single_product.php'>View More</a></div></div></div><br />    <br><br>
  </div>
</div>
