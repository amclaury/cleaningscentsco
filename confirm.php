...
<head>
  ...
  <title>Cleaning Scents Company - Checkout Success</title>
...
<body>
  ...
  <div id="search" class="row white-text grey darken-3" >
    ...
    <div class="container">
        ...
        <div class="container">
      <br><br>
        <h3 class="header indigo-text text-lighten-3">Checkout Success</h3>
        ...
        <div class="col s12 m7">
          <div class="card">
            <div class="card-content-xvx">
                    <div class="row">
				<p>Your order processed successfully! <br/>Your order confirmation number is CSC-23561.</p>
  </div>
            </div>
